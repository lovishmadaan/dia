...
def hatchBlend(image):
    ...
    hatchTexture = cv2.imread('./imgs/hatch.jpg', 0)
...
if __name__ == '__main__':
    ...
    cv2.namedWindow("Original in Grayscale", cv2.WINDOW_NORMAL)
    cv2.namedWindow("Edge DoG", cv2.WINDOW_NORMAL)
    cv2.namedWindow("XDoG GaryGrossi", cv2.WINDOW_NORMAL)
    cv2.namedWindow("XDoG Project 1", cv2.WINDOW_NORMAL)
    cv2.namedWindow("XDoG Project 2", cv2.WINDOW_NORMAL)
    cv2.namedWindow("XDoG Project 3 - Natural Media", cv2.WINDOW_NORMAL)
